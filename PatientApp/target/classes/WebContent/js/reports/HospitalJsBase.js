        ...
        success: function (responseData) {
            ...
            if (responseData['success'] == 1)
            {
                var fieldsDataWithoutOverrideWhereClause = responseData['fieldsDataWithoutOverrideWhereClause'];                
                	...
                	var hospital = fieldsDataWithoutOverrideWhereClause['hospital'];                
		                
		                
		                var hospName = hospital['hospName'];
		                $('[data-name="HospName"]').text(hospName);
		                
		                
		                var hospAddress = hospital['hospAddress'];
		                $('[data-name="HospAddress"]').text(hospAddress);
