...
@Entity
@Table(name = "Patient")
public class Patient extends RulesBean implements java.io.Serializable
{
	...
	@Column(name = "selectDoctor")
	private java.lang.String selectDoctor;
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		if(patientName!=null)
		{
			dataObject.addProperty("patientName", patientName);
		}
		else
		{
			dataObject.addProperty("patientName", "");
		}
		
		if(patientGender!=null)
		{
			dataObject.addProperty("patientGender", patientGender);
		}
		else
		{
			dataObject.addProperty("patientGender", "");
		}
		
		if(selectDoctor!=null)
		{
			dataObject.addProperty("selectDoctor", selectDoctor);
		}
		else
		{
			dataObject.addProperty("selectDoctor", "");
		}
		...
		{
			com.patientapp.bean.Doctor  doctor = (com.patientapp.bean.Doctor) session.get(com.patientapp.bean.Doctor.class, doctorId);   
			JsonObject doctorObj = doctor.getDataObject(true, session);
			dataObject.addProperty("doctorDisplayVal", doctorObj.get("lookupDisplayText").getAsString());
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = Patient.class.getMethod("get" + popertyNameEL);
