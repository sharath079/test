...
public class PrivilegeGroupItems extends RulesBean implements java.io.Serializable
{
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		{
			com.patientapp.bean.PrivilegeGroup  privilegeGroup = (com.patientapp.bean.PrivilegeGroup) session.get(com.patientapp.bean.PrivilegeGroup.class, privilegeGroupId);   
