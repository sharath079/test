	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
				...
				if(fetchForLookup==false)
		{
			if(privilegeGroupId != null && privilegeGroupId>0)
			{
				...
				PrivilegeGroup  privilegeGroupObj = (com.patientapp.bean.PrivilegeGroup) session.get(com.patientapp.bean.PrivilegeGroup.class, privilegeGroupId);   
		...
		{
			com.patientapp.bean.UserInfo  userInfo = (com.patientapp.bean.UserInfo) session.get(com.patientapp.bean.UserInfo.class, userInfoId);   
			...
			if (propertyHierarchy.length > 1)
			{
								...
								else if (propertyName.equals("PrivilegeGroupId"))
				{
					...
					if(privilegeGroupId != null && privilegeGroupId > 0)
					{
						...
						com.patientapp.bean.PrivilegeGroup privilegeGroupObj = (com.patientapp.bean.PrivilegeGroup) session.get(com.patientapp.bean.PrivilegeGroup.class, privilegeGroupId);
