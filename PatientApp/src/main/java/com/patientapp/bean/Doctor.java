...
@Entity
@Table(name = "Doctor")
public class Doctor extends RulesBean implements java.io.Serializable
{
	...
	public JsonObject getDataObject(boolean fetchForLookup, Session session)
	{
		...
		if(doctorName!=null)
		{
			dataObject.addProperty("doctorName", doctorName);
		}
		else
		{
			dataObject.addProperty("doctorName", "");
		}
		
		if(hospitalName!=null)
		{
			dataObject.addProperty("hospitalName", hospitalName);
		}
		else
		{
			dataObject.addProperty("hospitalName", "");
		}
	...
	public Object getPropertyValue(Session session, String popertyNameEL, JsonObject dataObject)
	{
		try
		{
			...
			{
				Method instanceMethod = Doctor.class.getMethod("get" + popertyNameEL);
