...
{
	private static final Logger logger = Logger.getLogger(DoctorControllerImpl.class);
    public DoctorControllerImpl(JsonObject userSessionInfo, Session organisationSession)
    {
