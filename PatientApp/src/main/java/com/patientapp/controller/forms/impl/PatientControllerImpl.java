...
import com.patientapp.controller.forms.base.PatientControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "PatientControllerImpl")
@RequestScoped*/
public class PatientControllerImpl extends PatientControllerBase 
{
	public PatientControllerImpl(Session session)
	{
		super(session);
	}
	public PatientControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	public void doAfterEntityLoadedImpl(Patient patient, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject patientDataObject, Patient patient)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(Patient patient, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(Patient patient, String attributeName)
	{
		//Custom handling	
	}
