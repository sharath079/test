...
import com.patientapp.controller.forms.base.HospitalControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "HospitalControllerImpl")
@RequestScoped*/
public class HospitalControllerImpl extends HospitalControllerBase 
{
	public HospitalControllerImpl(Session session)
	{
		super(session);
	}
	public HospitalControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	public void doAfterEntityLoadedImpl(Hospital hospital, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject hospitalDataObject, Hospital hospital)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(Hospital hospital, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(Hospital hospital, String attributeName)
	{
		//Custom handling	
	}
