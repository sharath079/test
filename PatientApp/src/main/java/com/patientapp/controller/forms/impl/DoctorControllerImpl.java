...
import com.patientapp.controller.forms.base.DoctorControllerBase;
 ...
 * 
 */
/*@ManagedBean(name = "DoctorControllerImpl")
@RequestScoped*/
public class DoctorControllerImpl extends DoctorControllerBase 
{
	public DoctorControllerImpl(Session session)
	{
		super(session);
	}
	public DoctorControllerImpl(Session session, JsonObject standardReqParams)
	{
	...
	{
		//Custom handling
		//DoctorControllerImpl impl=new DoctorControllerImpl();/*
		

		Session custSession= getDBSession();
	    String customHql="SELECT Doctor.doctorName,Doctor.hospitalName,Doctor.vwLastModifiedDate"
	    		+ "Patient.patientName FROM Doctor"
	    		+ "FULL JOIN Patient"
	    		+ "ON Doctor.doctorId = Patient.doctorId;";
	    //query.addQueryHint(customHql);
	    query=custSession.createSQLQuery(customHql);
	...
	{
		//Custom handling
		 /*queryString="SELECT Doctor.doctorName,Doctor.hospitalName,Doctor.vwLastModifiedDate"
	    		+ "Patient.patientName FROM Doctor"
	    		+ "FULL JOIN Patient"
	    		+ "ON Doctor.doctorId = Patient.doctorId;";*/
		return "";
	...
	public void doAfterEntityLoadedImpl(Doctor doctor, JsonObject initParamsInfo)
	{
		//Custom handling	
	}
	...
	public JsonObject doExecuteAPIRequestImpl(String apiName, JsonObject doctorDataObject, Doctor doctor)
	{
		// Custom handling
	...
	public void doAfterLookupRowSelectedImpl(Doctor doctor, String attributeName)
	{
		//Custom handling	
	}
	public void doAfterSelectOptionChangedImpl(Doctor doctor, String attributeName)
	{
		//Custom handling	
	}
