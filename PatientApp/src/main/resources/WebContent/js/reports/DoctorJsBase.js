        ...
        success: function (responseData) {
            ...
            if (responseData['success'] == 1)
            {
                var fieldsDataWithoutOverrideWhereClause = responseData['fieldsDataWithoutOverrideWhereClause'];                
                	...
                	var doctor = fieldsDataWithoutOverrideWhereClause['doctor'];                
		                
		                
		                var doctorName = doctor['doctorName'];
		                $('[data-name="DoctorName"]').text(doctorName);
		                
		                
		                var hospitalName = doctor['hospitalName'];
		                $('[data-name="HospitalName"]').text(hospitalName);
