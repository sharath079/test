...
function userLogin()
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'GET',
    	url : urlContextPath + '/loginSelfServiceUserTaskLayoutParameters',
        ...
        success: function (responseData)
        {
            ...
            {
    			var landingUrl =  gHomePageBeforeLoginUrlForTaskLayoutParameters;
...
function userLoginWithBranch()
{
    ...
    $.ajax({
        ...
        success: function (responseData)
        {
            ...
            if (responseData['success'] == 1)
            {
    			var landinUrl =  gHomePageBeforeLoginUrlForTaskLayoutParameters;
