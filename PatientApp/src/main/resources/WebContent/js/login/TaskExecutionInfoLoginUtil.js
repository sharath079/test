...
function userLogin()
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'GET',
    	url : urlContextPath + '/loginSelfServiceUserTaskExecutionInfo',
        ...
        success: function (responseData)
        {
            ...
            {
    			var landingUrl =  gHomePageBeforeLoginUrlForTaskExecutionInfo;
...
function userLoginWithBranch()
{
    ...
    $.ajax({
        ...
        success: function (responseData)
        {
            ...
            if (responseData['success'] == 1)
            {
    			var landinUrl =  gHomePageBeforeLoginUrlForTaskExecutionInfo;
