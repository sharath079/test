...
function userLogin()
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'GET',
    	url : urlContextPath + '/loginSelfServiceUserPrivilegeGroup',
        ...
        success: function (responseData)
        {
            ...
            {
    			var landingUrl =  gHomePageBeforeLoginUrlForPrivilegeGroup;
...
function userLoginWithBranch()
{
    ...
    $.ajax({
        ...
        success: function (responseData)
        {
            ...
            if (responseData['success'] == 1)
            {
    			var landinUrl =  gHomePageBeforeLoginUrlForPrivilegeGroup;
