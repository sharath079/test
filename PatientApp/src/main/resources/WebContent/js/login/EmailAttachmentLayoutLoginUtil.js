...
function userLogin()
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'GET',
    	url : urlContextPath + '/loginSelfServiceUserEmailAttachmentLayout',
        ...
        success: function (responseData)
        {
            ...
            {
    			var landingUrl =  gHomePageBeforeLoginUrlForEmailAttachmentLayout;
...
function userLoginWithBranch()
{
    ...
    $.ajax({
        ...
        success: function (responseData)
        {
            ...
            if (responseData['success'] == 1)
            {
    			var landinUrl =  gHomePageBeforeLoginUrlForEmailAttachmentLayout;
