...
function userLogin()
{
    ...
    $.ajax({
        ...
        dataType: 'json',
        type: 'GET',
    	url : urlContextPath + '/loginSelfServiceUserConfigProperties',
        ...
        success: function (responseData)
        {
            ...
            {
    			var landingUrl =  gHomePageBeforeLoginUrlForConfigProperties;
...
function userLoginWithBranch()
{
    ...
    $.ajax({
        ...
        success: function (responseData)
        {
            ...
            if (responseData['success'] == 1)
            {
    			var landinUrl =  gHomePageBeforeLoginUrlForConfigProperties;
